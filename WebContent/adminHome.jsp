<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <%@ page
        import="com.namastemart.service.impl.*, com.namastemart.beans.*, java.util.*, javax.servlet.ServletOutputStream, java.io.*"
        %>
        ...
        <body>
            <% /* Checking the user credentials */ String userType=(String) session.getAttribute("usertype"); String
                userName=(String) session.getAttribute("username"); String password=(String)
                session.getAttribute("password"); if (userType==null || !userType.equals("admin")) {
