...
<link rel="stylesheet" href="href=css/changes.css">
...
<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        <li>
            <a href="adminViewProduct.jsp"><span class="glyphicon glyphicon-home"></span><span class="menu-text"> Products</span></a>
        </li>
        ...
        <li>
            <a href="adminStock.jsp"><span class="glyphicon glyphicon-stats"></span><span class="menu-text"> Stock</span></a>
        </li>

        <li>
            <a href="shippedItems.jsp"><span class="glyphicon glyphicon-send"></span><span class="menu-text"> Shipped</span></a>
        </li>

        <li>
            <a href="unshippedItems.jsp"><span class="glyphicon glyphicon-list-alt"></span><span class="menu-text"> Orders</span></a>
        </li>
        ...
        <li>
            <a href="adminAction.jsp"><span class="glyphicon glyphicon-user"></span><span class="menu-text"> User Control</span></a>
        </li>

        <li>
            <a href="adminTrans.jsp"><span class="glyphicon glyphicon-credit-card"></span><span class="menu-text"> Transactions</span></a>
        </li>

        <li>
            <a href="./LogoutSrv"><span class="glyphicon glyphicon-log-out"></span><span class="menu-text"> Logout</span></a>
        </li>
    </ul>
</div>
