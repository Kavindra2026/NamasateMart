...
<body>
    ...
    <div class="container">
        <table class="table table-hover">
            <thead style="background-color: #b341ab; color: white; font-size: 16px; font-weight: bold;">
                <tr>
                    <th>Picture</th>
                    <th>Products</th>
                    <th>Price</th>
            ...
            <tbody style="background-color: #f1cdf6; font-size: 15px; font-weight: bold;">
                ...
                <tr style="background-color: #b341ab; color: white;">
                    <td colspan="4" style="text-align: center;">
                        <form method="post">
                            <button formaction="userHome.jsp" style="background-color: red; color: white;">Cancel</button>
                        </form>
                    </td>
                    <td colspan="2" align="center">
                        <form method="post">
                            <button style="background-color: rgb(7, 178, 7); color: white;" formaction="payment.jsp?amount=<%=totAmount%>">Pay Now</button>
                        </form>
                    </td>
                </tr>
                <%
