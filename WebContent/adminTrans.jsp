...
<head>
    ...
    <style>
        ...
        .alert-info { color: black; background-color: #008000ac; border-color: black; font-size: x-large; }
    </style>
</head>
<body>
    <%
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="" method="get" style="display:inline;">
                                    ...
                                    <button type="submit" name="action" value="refund" class="btn btn-warning">Refund</button>
                                </form>
                                <% } %>
                            </td>
                        </tr>
