...
<head>
    ...
    <style>
        ...
        .table-container { background-color: #f1cdf6; padding: 20px; }
        .footer { position: fixed; left: 250px; bottom: 0; width: calc(100% - 250px); background-color: #333; color: white; text-align: center; padding: 10px; transition: left 0.3s, width 0.3s; }
        .sidebar.collapsed .footer { left: 60px; width: calc(100% - 60px); }
        .btn { margin: 5px; }
        .user-image { width: 50px; height: 50px; border-radius: 50%; }
        .table-bordered>tbody>tr>td, .table-bordered>thead>tr>th { border: 1px solid black !important; }
    </style>
</head>
<body>
    <%
...
if (userType == null || !userType.equals("admin")) {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="get" style="display:inline;">
                                    ...
                                    <button type="submit" name="action" value="<%= actionStatus.toLowerCase() %>" class="btn <%= user.isActive() ? "btn-warning" : "btn-success" %>">
                                        <%= actionStatus %>
                                    </button>
                                </form>
                                <form action="" method="get" style="display:inline;">
                                    <input type="hidden" name="userId" value="<%= user.getEmail() %>">
                                    <button type="submit" name="action" value="delete" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this user?')">
                                        Remove
                                    </button>
                                </form>
                            </td>
    ...
    <div class="footer">
        <p>NamasteMart ©copy: 2026. All Rights Reserved.</p>
    </div>
</body>
</html>